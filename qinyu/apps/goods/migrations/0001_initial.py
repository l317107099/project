    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('is_delete', models.BooleanField(default=False, verbose_name='状态')),
                ('name', models.CharField(max_length=20, verbose_name='商品价格')),
                ...
                ('status', models.SmallIntegerField(choices=[(0, '上架'), (1, '下架')], default=1, verbose_name='上架状态')),
                ('goods', models.ForeignKey(on_delete='CASCADE', to='goods.Goods', verbose_name='商品SPU表')),
            ],
            options={
                'verbose_name': '商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.SmallIntegerField(default=0, verbose_name='展示顺序')),
                ('sku', models.ForeignKey(on_delete='CASCADE', to='goods.GoodsSKU', verbose_name='商品SKU')),
                ('type', models.ForeignKey(on_delete='CASCADE', to='goods.GoodsType', verbose_name='商品类型')),
            ],
            options={
                'verbose_name': '分类商品展示',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.SmallIntegerField(default=0, verbose_name='展示顺序')),
                ('sku', models.ForeignKey(on_delete='CASCADE', to='goods.GoodsSKU', verbose_name='商品')),
            ],
            options={
                'verbose_name': '首页轮播商品',
        ...
        migrations.AddField(
            model_name='goodssku',
            name='type',
            field=models.ForeignKey(on_delete='CASCADE', to='goods.GoodsType', verbose_name='商品类型'),
        ),
        migrations.CreateModel(
            name='GoodsImage',
            fields=[
